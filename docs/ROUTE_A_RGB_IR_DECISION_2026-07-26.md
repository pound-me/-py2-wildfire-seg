...
- RGB 基线 Fire IoU 最差 20 张（仅选择含真实 Fire 的验证图）已经导出 RGB、
  IR、GT 与预测拼图并完成逐图人工核查：RGB不可见20/20、heavy烟遮挡20/20、
  IR更清晰20/20；只有4/20被标为小火点。因此主导现象是烟遮挡下RGB不可见，
  不是“小火点占多数”。完整分布见`docs/RGB_VISIBILITY_MANUAL_DIAGNOSTIC_2026-07-26.md`。
