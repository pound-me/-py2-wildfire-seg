...
| FreqFusion | Frequency-Aware Feature Fusion for Dense Image Prediction | IEEE TPAMI, 2024 | 融合时对低分辨率特征自适应低通、高分辨率特征补高频，针对上采样边界模糊与小目标被粗特征淹没 | 小 | https://github.com/Linwei-Chen/FreqFusion （已核实） | [备用] |
